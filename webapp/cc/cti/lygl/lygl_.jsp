  ...
  <body>
    <div id="query_div" class="easyui-panel"   style="width:100%;">
	 ...
	 <table id="table_list"   border = 0 title="数据列表" style="width:100%;" 
		...
		<thead>
			<tr>
				<th data-options="field:'caller',align:'center'" width="10%">主叫</th>
				<th data-options="field:'called',align:'center'" width="10%">被叫</th>
				<th data-options="field:'begintime',align:'center'" width="10%">开始时间</th>
				<th data-options="field:'endtime',align:'center'" width="10%">结束时间</th>
				<th data-options="field:'gh',align:'center'" width="10%">工号</th>
			</tr>
		</thead>
	</table>
  </body>
