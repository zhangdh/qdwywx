...
<html>
  <head>
    <script src="ldxd.js" type="text/javascript"></script>
  </head>
  <body>
   		...
   		<table class="query_table">
   		   <form id="query_form">
   			<tr>
	    		...
	    		<td class="query_text"><input name="cx_called" class="easyui-textbox"></td>
	    		<td class="query_label">工号</td>
	    		<td class="query_text"><input name="cx_gh" class="easyui-textbox"></td>
